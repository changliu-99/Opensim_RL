...
class SequentialMemory(Memory):
    ...
    def save(self, pathname):
        # self.lock.acquire()
        pickle.dump([self.actions,self.rewards,self.terminals,self.observations], open(pathname, 'wb'), True)
        print('memory dumped into',pathname)
        # self.lock.release()

    def load(self, pathname):
        [self.actions,self.rewards,self.terminals,self.observations] = pickle.load(open(pathname, 'rb'))
