...
class DDPGAgent_Chang(Agent):
    ...
    def __init__(self, nb_actions, actor, critic, critic_action_input, memory,
        ...
        super(DDPGAgent_Chang, self).__init__(**kwargs)
...
# seem to be implemented already 
    # def replay(self, batch_size):
    #     minibatch = random.sample(self.memory, batch_size)
    #     for self.state, self.action, reward, next_state, done in minibatch:
    #         target = reward
    #         if not done:
